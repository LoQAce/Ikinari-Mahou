...
[ptext  layer="3"  page="fore"  text="Prode"  size="30"  x="165"  y="70"  color="white"  ]
...
[ptext  layer="3"  page="fore"  text="Liv."  size="40"  x="343"  y="20"  color="white"  time="0"  ]
...
[layopt  layer="3"  visible="true"  ]
[ptext  layer="3"  page="fore"  text="Arcidemone"  size="30"  x="165"  y="70"  color="white"  ]
...
[glink  storage="battle.ks"  clickse="01_b_008.ogg"  name="command1"  target="*atack"  text="Combatti"  layer="1"  size="30"  x="25"  y="510"  ]
[glink  storage="battle.ks"  clickse="01_b_008.ogg"  name="command1"  target="*run_away"  text="Fuggi"  layer="1"  size="30"  x="25"  y="565"  ]
[glink  storage="magic.ks"  clickse="01_b_008.ogg"  name="command1"  target="*magic"  text="Incantesimo"  layer="1"  size="30"  x="25"  y="620"  ]
[glink  storage="tool.ks"  clickse="01_b_008.ogg"  name="command1"  target="*tool"  text="Oggetto"  layer="1"  size="30"  x="25"  y="675"  ]
[endmacro  ]
[macro  name="arcenmy_action_command"  ]
[glink  storage="battle.ks"  name="command1"  clickse="01_b_008.ogg"  target="*arcenemy_atack"  text="Combatti"  layer="1"  size="30"  x="25"  y="510"  ]
[glink  storage="battle.ks"  name="command1"  clickse="01_b_008.ogg"  target="*arcenemy_run_away"  text="Fuggi"  layer="1"  size="30"  x="25"  y="565"  ]
[glink  storage="magic.ks"  name="command1"  clickse="01_b_008.ogg"  target="*arcenemy_magic"  text="Incantesimo"  layer="1"  size="30"  x="25"  y="620"  ]
[glink  storage="tool.ks"  name="command1"  clickse="01_b_008.ogg"  target="*arcenemy_tool"  text="Oggetto"  layer="1"  size="30"  x="25"  y="675"  ]
[endmacro  ]
...
[glink  name="command1"  clickse="01_b_008.ogg"  target="*check_magic"  exp="tf.magic=1"  text="Fuoco&nbsp;(30PM)"  x="290"  y="510"  ]
[glink  name="command1"  clickse="01_b_008.ogg"  target="*check_magic"  exp="tf.magic=2"  text="Tempesta&nbsp;(30PM)"  x="290"  y="565"  ]
[glink  name="command1"  clickse="01_b_008.ogg"  target="*check_magic"  exp="tf.magic=3"  text="Scambio&nbsp;(30PM)"  x="290"  y="620"  ]
[glink  name="command1"  clickse="01_b_008.ogg"  target="*check_magic"  exp="tf.magic=4"  text="Sacro&nbsp;(100PM)"  x="595"  y="510"  ]
[endmacro  ]
[macro  name="arcenmy_magic_command"  ]
[image  layer="0"  name="brave_name"  page="fore"  visible="true"  top="473"  left="295"  storage="arcenemy/2_battle/2_Window/sub_window.png"  ]
[glink  name="command1"  target="*arcenemy_check_magic"  clickse="01_b_008.ogg"  exp="tf.arcenemy_magic=1"  text="Fuoco&nbsp;infernale&nbsp;(50PM)"  x="290"  y="510"  ]
[glink  name="command1"  target="*arcenemy_check_magic"  clickse="01_b_008.ogg"  exp="tf.arcenemy_magic=2"  text="Gelo&nbsp;(50PM)"  x="290"  y="565"  ]
[glink  name="command1"  target="*arcenemy_check_magic"  clickse="01_b_008.ogg"  exp="tf.arcenemy_magic=3"  text="Salto&nbsp;temporale&nbsp;(100PM)"  x="595"  y="510"  ]
[endmacro  ]
[macro  name="tool_command"  ]
[image  layer="0"  name="brave_name"  page="fore"  visible="true"  top="473"  left="295"  storage="arcenemy/2_battle/2_Window/sub_window.png"  ]
[glink  name="command1"  clickse="02_b_006.ogg"  text="Diario&nbsp;del&nbsp;Prode"  target="*brave_diary"  x="290"  y="510"  ]
[glink  name="command1"  clickse="02_b_006.ogg"  text="Missiva&nbsp;del&nbsp;Maestro"  target="*brave_letter"  x="290"  y="565"  ]
[glink  name="command1"  clickse="02_b_006.ogg"  text="Libro&nbsp;dei&nbsp;Mastri&nbsp;di&nbsp;Pugna"  target="*brave_book"  x="290"  y="620"  ]
[glink  name="command1"  clickse="02_b_006.ogg"  text="Mensile&nbsp;del&nbsp;Mago&nbsp;Magico"  target="*brave_dummy"  x="290"  y="675"  ]
[glink  name="command1"  text="Erba&nbsp;Medica"  target="*breve_select_tool"  clickse="01_b_008.ogg"  cond="f.braveLeaf>0"  exp="tf.tool=1"  x="655"  y="510"  ]
[glink  name="command1"  text="Etere"  target="*breve_select_tool"  clickse="01_b_008.ogg"  cond="f.braveLeaf>0&&f.braveEther>0"  exp="tf.tool=2"  x="655"  y="565"  ]
[glink  name="command1"  text="Etere"  target="*breve_select_tool"  clickse="01_b_008.ogg"  cond="f.braveLeaf==0&&f.braveEther>0"  exp="tf.tool=2"  x="655"  y="510"  ]
[endmacro  ]
[macro  name="arcenemy_tool_command"  ]
[image  layer="0"  name="brave_name"  page="fore"  visible="true"  top="473"  left="295"  storage="arcenemy/2_battle/2_Window/sub_window.png"  ]
[glink  name="command1"  text="Diario&nbsp;dell'Aricidemone"  clickse="02_b_006.ogg"  target="*arcenemy_diary"  x="290"  y="510"  ]
[glink  name="command1"  text="Missive&nbsp;dalle&nbsp;Élite&nbsp;Malevoli"  clickse="02_b_006.ogg"  target="*arcenemy_letter"  x="290"  y="565"  ]
[glink  name="command1"  text="Vademecum&nbsp;dell'Arcidemone"  clickse="02_b_006.ogg"  target="*arcenemy_dummy"  x="290"  y="620"  ]
[glink  name="command1"  text="Erba&nbsp;Medica"  clickse="01_b_008.ogg"  target="*arcenemy_select_tool"  cond="f.daemonLeaf>0"  exp="tf.arcenemy_tool=1"  x="290"  y="675"  ]
[glink  name="command1"  text="Etere"  clickse="01_b_008.ogg"  target="*arcenemy_select_tool"  cond="f.daemonLeaf>0&&f.daemonEther>0"  exp="tf.arcenemy_tool=2"  x="655"  y="510"  ]
[glink  name="command1"  text="Etere"  clickse="01_b_008.ogg"  target="*arcenemy_select_tool"  cond="f.daemonLeaf>0&&f.daemonEther>1"  exp="tf.arcenemy_tool=2"  x="655"  y="565"  ]
[glink  name="command1"  text="Etere"  clickse="01_b_008.ogg"  target="*arcenemy_select_tool"  cond="f.daemonLeaf==0&&f.daemonEther>0"  exp="tf.arcenemy_tool=2"  x="290"  y="675"  ]
[glink  name="command1"  text="Etere"  clickse="01_b_008.ogg"  target="*arcenemy_select_tool"  cond="f.daemonLeaf==0&&f.daemonEther>1"  exp="tf.arcenemy_tool=2"  x="655"  y="510"  ]
[endmacro  ]
...
[hankaku_trans  ]
[eval  exp="tf.dl_braveMagicPoint=tf.tmp_point"  ]
[ptext  layer="3"  page="fore"  text="Prode"  size="30"  x="190"  y="70"  color="0xFF7862"  time="0"  ]
...
[ptext  layer="3"  page="fore"  text="Liv."  size="40"  x="343"  y="20"  color="0xFF7862"  time="0"  ]
